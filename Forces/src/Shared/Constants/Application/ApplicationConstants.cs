namespace Forces.Shared.Constants.Application
{
    public static class ApplicationConstants
    {
        public static class SignalR
        {
            ...
            public const string NotifySteppers = "NotifySteppers";
            public const string NotifyvCodeControllers = "NotifyvCodeControllers";
