...
namespace Forces.Application.Features.BaseDashboards.Queries.GetData
{
    public class GetBaseDashboardDataQuery : IRequest<Result<BaseDashboardDataResponse>>
    {
        public int BaseId { get; set; }
    }

    internal class GetBaseDashboardDataQueryHandler : IRequestHandler<GetBaseDashboardDataQuery, Result<BaseDashboardDataResponse>>
    {
        private readonly IUnitOfWork<int> _unitOfWork;
        private readonly IUserService _userService;
        private readonly IRoleService _roleService;
        private readonly IStringLocalizer<GetBaseDashboardDataQueryHandler> _localizer;
